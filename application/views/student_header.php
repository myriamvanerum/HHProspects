...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <?php echo anchor('Home/index', 'Halmstad Hogskolan - Prospects *** Student', 'class="navbar-brand"'); ?>
    </div>
    <!-- /.navbar-header -->
    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        if ($student != null) {
            ...
            ?>
            <li class="dropdown">
                <?php echo anchor('Login_student/login_screen', '<i class="fa fa-user fa-fw"></i> Login', 'class="dropdown-toggle"'); ?>
            </li>
    <?php
}
?>
